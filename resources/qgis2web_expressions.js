...
function exp_road_segment_1rule0_eval_expression(context) {
    // "1 Hour" = 'true'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('1 Hour')  == 'true');
    } else {
        return (feature.get('1 Hour')  == 'true');
    }
}
...
function exp_road_segment_1rule1_eval_expression(context) {
    // "2 Hour" = 'true'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('2 Hour')  == 'true');
    } else {
        return (feature.get('2 Hour')  == 'true');
    }
}
...
function exp_road_segment_1rule2_eval_expression(context) {
    // "3 Hour" = 'true'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('3 Hour')  == 'true');
    } else {
        return (feature.get('3 Hour')  == 'true');
    }
}
...
function exp_road_segment_1rule3_eval_expression(context) {
    // "4 Hour" = 'true'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('4 Hour')  == 'true');
    } else {
        return (feature.get('4 Hour')  == 'true');
    }
}
...
function exp_road_segment_1rule4_eval_expression(context) {
    // Unrestricted = 'true'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Unrestricted')  == 'true');
    } else {
        return (feature.get('Unrestricted')  == 'true');
    }
}